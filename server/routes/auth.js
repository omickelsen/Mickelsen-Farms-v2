...
router.get('/google', (req, res) => {
  const redirectUri = process.env.NODE_ENV === 'production'
    ? [
        ...
        'https://mickelsenfamilyfarms.com/auth/google/callback',
        'https://www.mickelsenfamilyfarms.com/auth/google/callback',
      ][Math.floor(Math.random() * 3)] // Randomly select one for load balancing
  ...
  try {
    const { tokens } = await oauth2Client.getToken({
      ...
      redirect_uri: process.env.NODE_ENV === 'production'
        ? [
            ...
            'https://mickelsenfamilyfarms.com/auth/google/callback',
            'https://www.mickelsenfamilyfarms.com/auth/google/callback',
          ][Math.floor(Math.random() * 3)] // Randomly select one
        : 'http://localhost:5000/auth/google/callback',
    });
    ...
    const baseUrl = process.env.NODE_ENV === 'production'
      ? [
          ...
          'https://mickelsenfamilyfarms.com',
